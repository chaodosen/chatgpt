...
function Markdown(props) {
    ...
    const renderedWidth = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(0);
    const inView = (0,react__WEBPACK_IMPORTED_MODULE_2__.useRef)(!!props.defaultShow);
    const [_, triggerRender] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(0);
    const checkInView = (0,use_debounce__WEBPACK_IMPORTED_MODULE_7__/* .useThrottledCallback */ .zl)(()=>{
    ...
    const getSize = (x)=>!inView.current && x > 0 ? x : "auto";
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
